                    ...
                    <tbody class="align-middle" id="products">
                        @foreach ($productQuantity as $product)
                            <tr>
                                ...
                                <td class="align-middle">${{$product['product']['price']-($product['product']['price']*$product['product']['discount'])}}</td>
                                <td class="align-middle">
                                ...
                                <td class="align-middle">${{ ($product['product']['price']-($product['product']['price']*$product['product']['discount'])) * $product['quantity'] }}</td>
                                <td class="align-middle">
